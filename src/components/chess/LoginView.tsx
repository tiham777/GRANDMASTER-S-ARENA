        ...
        <div className="rounded-2xl border border-stone-800 bg-stone-900/80 backdrop-blur-sm shadow-2xl shadow-black/40 overflow-hidden">
          ...
          <div className="p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="size-11 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center shadow-lg shadow-amber-900/40">
                <Crown className="size-6 text-stone-950" />
              </div>
              <div>
                <h1 className="text-xl font-semibold tracking-tight text-stone-100">
                  Grandmaster&apos;s Arena
                </h1>
                <p className="text-xs text-stone-400">Online Chess · Firebase</p>
              </div>
            </div>
            ...
            <AnimatePresence mode="wait">
              {mode === "choose" && (
                ...
                >
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-2 text-[11px] text-stone-500">
                    <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-stone-950/40 border border-stone-800/60">
